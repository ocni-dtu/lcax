import { Button, Container, SimpleGrid, Stack, Title, Text } from '@mantine/core'
...
const Hero = () => (
  <Stack justify='center' align='center' mih='70vh' px='lg'>
    ...
    <Button c='black' mt='xl' component={Link} to='/concept/introduction' w={'fit-content'} size='xl'>
      Get started
    </Button>
  </Stack>
)
