...
import validateSimplePY from './code/validate_simple.py?raw'
import validateSimpleTS from './code/validateSimple.ts?raw'
import validateSimpleRS from './code/validate_simple.rs?raw'
import projectJSON from './code/project.json?raw'
import validateErrorPY from './code/validate_error.py?raw'
import validateErrorTS from './code/validateError.ts?raw'
import validateErrorRS from './code/validate_error.rs?raw'
import validateNestedPY from './code/validate_nested.py?raw'
import validateNestedTS from './code/validateNested.ts?raw'
import validateNestedRS from './code/validate_nested.rs?raw'
