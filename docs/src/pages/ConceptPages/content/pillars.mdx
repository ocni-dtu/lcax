...
description: A comprehensive overview of LCAx's core components - Data Structure, Conversion, Validation, and Calculation - explaining how these pillars work together to enable transparent and traceable Life Cycle Assessment in construction projects.
keywords:
  - data-structure
  - conversion
  - validation
...
import pillars from '@/assets/lcax_pillars.svg'
import { Image } from '@mantine/core'

<Image src={pillars} alt='LCAx Pillars' />

## Data Structure

At the center of the LCAx project is the data structure.

The data structure is at the core of the project and is the foundation that the rest of the pillars are built upon and
leverage.
...
Therefore, it is necessary to be able to check and validate data structure against custom logic.
