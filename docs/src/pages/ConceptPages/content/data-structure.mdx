...
import dataStructure from '@/assets/lcax_data_structure.svg'
import { Image } from '@mantine/core'

<Image src={dataStructure} alt='LCAx Data Structure' />
...
The JSON schema can be found [here](/reference/schemas/lcax)
