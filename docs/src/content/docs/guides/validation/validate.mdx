...
import validatePY from '@/content/code/python/validate_simple.py?raw'
...
import validateTS from '@/content/code/javascript/validateSimple.ts?raw'
import validateErrorTS from '@/content/code/javascript/validateError.ts?raw'
import validateNestedTS from '@/content/code/javascript/validateNested.ts?raw'
import validateRS from '@/content/code/rust/validate_simple.rs?raw'
import validateErrorRS from '@/content/code/rust/validate_error.rs?raw'
import validateNestedRS from '@/content/code/rust/validate_nested.rs?raw'
...
<CodeVariants
    variants={[
        ...
        {label: 'TypeScript', title: 'validate.ts', code: validateErrorTS, lang: 'ts'},
        {label: 'Rust', title: 'validate.rs', code: validateErrorRS, lang: 'rs'},
        {label: 'Data', title: 'project.json', code: projectJSON, lang: 'json'},
    ]}
    syncKey='lang'
/>
...
<CodeVariants
    variants={[
        ...
        {label: 'TypeScript', title: 'validate.ts', code: validateNestedTS, lang: 'ts'},
        {label: 'Rust', title: 'validate.rs', code: validateNestedRS, lang: 'rs'},
        {label: 'Data', title: 'project.json', code: projectJSON, lang: 'json'},
    ]}
    syncKey='lang'
/>