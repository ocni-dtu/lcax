...
pub struct ProjectSchema {
    ...
    pub life_cycle_modules: Option<ValidationRules>,
    pub impact_categories: Option<ValidationRules>,
    pub assemblies: Option<AssemblyReference>,
...
pub struct Reference {
    pub uri: Option<ValidationRules>,
    pub format: Option<ValidationRules>,
    pub version: Option<ValidationRules>,
    pub overrides: Option<ValidationRules>,
}
...
pub struct Assembly {
    ...
    pub description: Option<ValidationRules>,
    pub comment: Option<ValidationRules>,
    pub quantity: Option<ValidationRules>,
    pub unit: Option<ValidationRules>,
    pub classification: Option<ValidationRules>,
    pub products: Option<ValidationRules>,
    pub results: Option<ValidationRules>,
    pub meta_data: Option<ValidationRules>,
}